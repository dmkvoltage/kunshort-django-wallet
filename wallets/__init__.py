...
def __getattr__(name: str):
	...
	if name in {
		...
		return {
			...
			"WalletTransactionAlreadyFinalizedError": WalletTransactionAlreadyFinalizedError,
			"WalletTransactionDuplicateExternalIdError": WalletTransactionDuplicateExternalIdError,
			"WalletTransactionExternalIdRequiredError": WalletTransactionExternalIdRequiredError,
			"WalletTransactionInvalidStatusError": WalletTransactionInvalidStatusError,
			"WalletTransactionNotFoundError": WalletTransactionNotFoundError,
